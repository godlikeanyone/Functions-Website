...
export function Navigation({ locale = "en", onLocaleChange, onThemeToggle, theme = "dark" }: NavigationProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 rounded-b-2xl shadow-lg shadow-black/5">
      <div className="relative bg-background/50 backdrop-blur-md">
